...
class Formulario extends React.Component{
	...
	componentDidMount() {
		//Se lee fields.json con campos a pintar y se guarda en el estado del componente
		this.setState({campos: fields});
	}
	//Nuevo input de texto
	nuevoCampoTexto = () => {
		swal.fire({
		  title:"<p style='font-size: 15pt;font-weight:600;color: #282828;'>Ingrese el campo de texto que desea agregar</p>",
					...
					<div className="row">
						...
						<div className="col-sm-9">
							<form>
							{
								...
								switch(campo.type){
									case "text": return(
										<div className="form-group prefInput mt-3 ">
											<label className="block text-sm font-medium text-gray-700" for={campo.uid}>{campo.label}</label>
											<input type="text" className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md form-control" id={campo.uid}/>
									...
									case "select": return(
										<div className="form-group prefInput">
										  ...
										  <select className="mt-1 block w-full  form-group prefInput py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" id={campo.uid}>
									...
									case "radio": return(
										<div className="form-group prefInput">
										  <input className="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" type="radio" id={campo.uid}/>
